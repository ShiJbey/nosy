...
class NosyListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by NosyParser#entity_spec.
    def enterEntity_spec(self, ctx:NosyParser.Entity_specContext):
        pass

    # Exit a parse tree produced by NosyParser#entity_spec.
    def exitEntity_spec(self, ctx:NosyParser.Entity_specContext):
        pass


    # Enter a parse tree produced by NosyParser#value_spec.
    def enterValue_spec(self, ctx:NosyParser.Value_specContext):
        pass

    # Exit a parse tree produced by NosyParser#value_spec.
    def exitValue_spec(self, ctx:NosyParser.Value_specContext):
        pass
    ...
    # Enter a parse tree produced by NosyParser#range_predicate_symbol.
    def enterRange_predicate_symbol(self, ctx:NosyParser.Range_predicate_symbolContext):
        pass

    # Exit a parse tree produced by NosyParser#range_predicate_symbol.
    def exitRange_predicate_symbol(self, ctx:NosyParser.Range_predicate_symbolContext):
        pass
